...
CREATE TABLE `lessons` (
	...
	`description` text,
	`content_types` enum('MDX','VIDEO') NOT NULL,
...
ALTER TABLE `lessons` ADD CONSTRAINT `lessons_module_id_modules_id_fk` FOREIGN KEY (`module_id`) REFERENCES `modules`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
